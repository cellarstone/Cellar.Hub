...
func (mw LoggingMiddleware) GetAllMeetingRooms() (result []CellarMeetingRoom, err error) {
...
func (mw LoggingMiddleware) GetMeetingRoom(id string) (result CellarMeetingRoom, err error) {
	defer func(begin time.Time) {
		mw.logger.Log(
...
func (mw LoggingMiddleware) AddMeetingRoom(item CellarMeetingRoom) (result CellarMeetingRoom, err error) {
	defer func(begin time.Time) {
		mw.logger.Log(
...
func (mw LoggingMiddleware) RemoveMeetingRoom(id string) (err error) {
	defer func(begin time.Time) {
		mw.logger.Log(
...
func (mw LoggingMiddleware) UpdateMeetingRoom(item CellarMeetingRoom) (result CellarMeetingRoom, err error) {
	defer func(begin time.Time) {
		mw.logger.Log(
...
func (mw LoggingMiddleware) GetAllMeetingRoomsModel() (result []MeetingRoomVM, err error) {
	defer func(begin time.Time) {
		mw.logger.Log(
			"function", "GetAllMeetingRoomsModel",
			"err", err,
			"took", time.Since(begin),
		)
	}(time.Now())
...
func (mw LoggingMiddleware) GetMeetingRoomModel(id string) (result MeetingRoomVM, err error) {
	defer func(begin time.Time) {
		mw.logger.Log(
