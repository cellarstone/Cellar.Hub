    ...
    stage('Development') {
      steps {
        parallel (
          ...
          db: {
            sh 'dotnet restore ./Cellar.Hub.Db'
            sh 'dotnet build ./Cellar.Hub.Db --configuration Release'
            sh 'dotnet publish ./Cellar.Hub.Db --configuration Release'
          ...
          mqtt: {
            ...
            sh 'dotnet publish ./Cellar.Hub.Mqtt --configuration Release'
