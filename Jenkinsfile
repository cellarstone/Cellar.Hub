  ...
  stages {
    ...
    stage('Publish - Core') {
      ...
      steps {
        parallel (
          traefik: {
            sh 'docker tag cellar.hub.proxy cellarstone/cellar.hub.proxy:0.50.0'
            sh 'docker push cellarstone/cellar.hub.proxy:0.50.0'
          },
          web: {
            sh 'docker tag cellar.hub.core.web cellarstone/cellar.hub.core.web:0.50.0'
            sh 'docker push cellarstone/cellar.hub.core.web:0.50.0'
          },
          admin: {
            sh 'docker tag cellar.hub.core.admin cellarstone/cellar.hub.core.admin:0.50.0'
            sh 'docker push cellarstone/cellar.hub.core.admin:0.50.0'
          },
          iot: {
            sh 'docker tag cellar.hub.core.iot cellarstone/cellar.hub.core.iot:0.50.0'
            sh 'docker push cellarstone/cellar.hub.core.iot:0.50.0'
          },
          file: {
            sh 'docker tag cellar.hub.core.file cellarstone/cellar.hub.core.file:0.50.0'
            sh 'docker push cellarstone/cellar.hub.core.file:0.50.0'
          },
          workflow: {
            sh 'docker tag cellar.hub.core.workflow cellarstone/cellar.hub.core.workflow:0.50.0'
            sh 'docker push cellarstone/cellar.hub.core.workflow:0.50.0'
          },
          websockets: {
            sh 'docker tag cellar.hub.core.websockets cellarstone/cellar.hub.core.websockets:0.50.0'
            sh 'docker push cellarstone/cellar.hub.core.websockets:0.50.0'
          },
          mongodb: {
            sh 'docker tag cellar.hub.mongodb cellarstone/cellar.hub.mongodb:0.50.0'
            sh 'docker push cellarstone/cellar.hub.mongodb:0.50.0'
          },
          fluentd: {
            sh 'docker tag cellar.hub.fluentd cellarstone/cellar.hub.fluentd:0.50.0'
            sh 'docker push cellarstone/cellar.hub.fluentd:0.50.0'
          },
          prometheus: {
            sh 'docker tag cellar.hub.prometheus cellarstone/cellar.hub.prometheus:0.50.0'
            sh 'docker push cellarstone/cellar.hub.prometheus:0.50.0'
          },
          telegraf: {
            sh 'docker tag cellar.hub.telegraf cellarstone/cellar.hub.telegraf:0.50.0'
            sh 'docker push cellarstone/cellar.hub.telegraf:0.50.0'
          }
        )
      }
    }
    stage('Publish - Modules') {
      ...
      steps {
        parallel (
          office_api: {
            sh 'docker tag cellar.hub.module.office.api cellarstone/cellar.hub.module.office.api:0.50.0'
          ...
          office_welcome: {
            ...
            sh 'docker push cellarstone/cellar.hub.module.office.welcome:0.50.0'
          }
        )
      }
    }
