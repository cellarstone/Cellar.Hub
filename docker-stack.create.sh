...
if [ "$IS_FLUENTD_EXIST" != "" ]; then
    ...
    docker service update --image cellarstone/cellar.hub.fluentd:0.45.0 \
                      --replicas 1 \
    ...
    docker service create --name fluentd \
                      ...
                      --publish 24224:24224 \
                      --with-registry-auth \
                      cellarstone/cellar.hub.fluentd:0.45.0
...
if [ "$IS_MONGO_EXIST" != "" ]; then
    ...
    docker service update --image cellarstone/cellar.hub.mongodb:0.45.0 \
                      --replicas 1 \
                      --update-parallelism 2 \
                      --update-delay 5s \
                      --update-order start-first \
    ...
    docker service create --name mongodb \
                      ...
                      --publish 27017:27017 \
                      --with-registry-auth \
                      cellarstone/cellar.hub.mongodb:0.45.0
...
if [ "$IS_MQTT_EXIST" != "" ]; then
    ...
    docker service update --image cellarstone/cellar.hub.mqtt:0.45.0 \
                      --replicas 1 \
                      --update-parallelism 2 \
                      --update-delay 5s \
                      --update-order start-first \
    ...
    docker service create --name mqtt \
                      ...
                      --publish 1883:1883 \
                      --with-registry-auth \
                      cellarstone/cellar.hub.mqtt:0.45.0
...
if [ "$IS_PROMETHEUS_EXIST" != "" ]; then
    ...
    docker service update --image cellarstone/cellar.hub.prometheus:0.45.0 \
                      --replicas 1 \
                      --update-parallelism 2 \
                      --update-delay 5s \
                      --update-order start-first \
    ...
    docker service create --name prometheus \
                      ...
                      --publish 9090:9090 \
                      --with-registry-auth \
                      cellarstone/cellar.hub.prometheus:0.45.0
...
if [ "$IS_TELEGRAF_EXIST" != "" ]; then
    ...
    docker service update --image cellarstone/cellar.hub.telegraf:0.45.0 \
                      --replicas 1 \
                      --update-parallelism 2 \
                      --update-delay 5s \
                      --update-order start-first \
    ...
    docker service create --name telegraf \
                      ...
                      --with-registry-auth \
                      cellarstone/cellar.hub.telegraf:0.45.0
...
if [ "$IS_HUBCOREWEB_EXIST" != "" ]; then
    ...
    docker service update --image cellarstone/cellar.hub.core.web:0.45.0 \
                      --replicas 1 \
                      --update-parallelism 2 \
                      --update-delay 5s \
                      --update-order start-first \
    ...
    docker service create --name cellar-hub-core-web \
                      ...
                      --with-registry-auth \
                      --publish 44401:44401 \
                      cellarstone/cellar.hub.core.web:0.45.0     
...
if [ "$IS_HUBCOREADMIN_EXIST" != "" ]; then
    ...
    docker service update --image cellarstone/cellar.hub.core.admin:0.45.0 \
                      --replicas 1 \
                      --update-parallelism 2 \
                      --update-delay 5s \
                      --update-order start-first \
    ...
    docker service create --name cellar-hub-core-admin \
                      ...
                      --with-registry-auth \
                      --publish 44402:44402 \
                      cellarstone/cellar.hub.core.admin:0.45.0     
...
if [ "$IS_HUBCOREFILE_EXIST" != "" ]; then
    ...
    docker service update --image cellarstone/cellar.hub.core.file:0.45.0 \
                      --replicas 1 \
                      --update-parallelism 2 \
                      --update-delay 5s \
                      --update-order start-first \
    ...
    docker service create --name cellar-hub-core-file \
                      ...
                      --publish 44404:44404 \
                      --with-registry-auth \
                      cellarstone/cellar.hub.core.file:0.45.0     
...
if [ "$IS_HUBCOREWEBSOCKETS_EXIST" != "" ]; then
    ...
    docker service update --image cellarstone/cellar.hub.core.websockets:0.45.0 \
                      --replicas 1 \
                      --update-parallelism 2 \
                      --update-delay 5s \
                      --update-order start-first \
    ...
    docker service create --name cellar-hub-core-websockets \
                      ...
                      --publish 44406:44406 \
                      --with-registry-auth \
                      cellarstone/cellar.hub.core.websockets:0.45.0     
...
if [ "$IS_HUBCOREIOT_EXIST" != "" ]; then
    ...
    docker service update --image cellarstone/cellar.hub.core.iot:0.45.0 \
                      --replicas 1 \
                      --update-parallelism 2 \
                      --update-delay 5s \
                      --update-order start-first \
    ...
    docker service create --name cellar-hub-core-iot \
                      ...
                      --with-registry-auth \
                      --publish 44403:44403 \
                      cellarstone/cellar.hub.core.iot:0.45.0     
...
#     docker service update --image cellarstone/cellar.hub.core.user:0.45.0 \
#                       --replicas 1 \
#                       --update-parallelism 2 \
#                       --update-delay 5s \
#                       --update-order start-first \
...
#                       --with-registry-auth \
#                       --publish 44407:44407 \
#                       cellarstone/cellar.hub.core.user:0.45.0     
...
if [ "$IS_HUBCOREWORKFLOW_EXIST" != "" ]; then
    ...
    docker service update --image cellarstone/cellar.hub.core.workflow:0.45.0 \
                      --replicas 1 \
                      --update-parallelism 2 \
                      --update-delay 5s \
                      --update-order start-first \
    ...
    docker service create --name cellar-hub-core-workflow \
                      ...
                      --publish 44405:44405 \
                      --with-registry-auth \
                      cellarstone/cellar.hub.core.workflow:0.45.0     
...
if [ "$IS_HUBMODULE_OFFICEAPI_EXIST" != "" ]; then
    ...
    docker service update --image cellarstone/cellar.hub.module.office.api:0.45.0 \
                      --replicas 1 \
                      --update-parallelism 2 \
                      --update-delay 5s \
                      --update-order start-first \
    ...
    docker service create --name cellar-hub-module-office-api \
                      ...
                      --publish 44513:44513 \
                      --with-registry-auth \
                      cellarstone/cellar.hub.module.office.api:0.45.0
...
if [ "$IS_HUBMODULE_OFFICEMEETINGS_EXIST" != "" ]; then
    ...
    docker service update --image cellarstone/cellar.hub.module.office.meetingrooms:0.45.0 \
                      --replicas 1 \
                      --update-parallelism 2 \
                      --update-delay 5s \
                      --update-order start-first \
    ...
    docker service create --name cellar-hub-module-office-meetingrooms \
                      ...
                      --publish 44511:44511 \
                      --with-registry-auth \
                      cellarstone/cellar.hub.module.office.meetingrooms:0.45.0
...
if [ "$IS_HUBMODULE_OFFICERECEPTION_EXIST" != "" ]; then
    ...
    docker service update --image cellarstone/cellar.hub.module.office.reception:0.45.0 \
                      --replicas 1 \
                      --update-parallelism 2 \
                      --update-delay 5s \
                      --update-order start-first \
    ...
    docker service create --name cellar-hub-module-office-reception \
                      ...
                      --publish 44512:44512 \
                      --with-registry-auth \
                      cellarstone/cellar.hub.module.office.reception:0.45.0
...
if [ "$IS_HUBMODULE_OFFICECAFE_EXIST" != "" ]; then
    ...
    docker service update --image cellarstone/cellar.hub.module.office.cafe:0.45.0 \
                      --replicas 1 \
                      --update-parallelism 2 \
                      --update-delay 5s \
                      --update-order start-first \
    ...
    docker service create --name cellar-hub-module-office-cafe \
                      ...
                      --publish 44514:44514 \
                      --with-registry-auth \
                      cellarstone/cellar.hub.module.office.cafe:0.45.0
...
if [ "$IS_HUBMODULE_OFFICEWELCOME_EXIST" != "" ]; then
    ...
    docker service update --image cellarstone/cellar.hub.module.office.welcome:0.45.0 \
                      --replicas 1 \
                      --update-parallelism 2 \
                      --update-delay 5s \
                      --update-order start-first \
    ...
    docker service create --name cellar-hub-module-office-welcome \
                      ...
                      --publish 44515:44515 \
                      --with-registry-auth \
                      cellarstone/cellar.hub.module.office.welcome:0.45.0
...
if [ "$IS_HUBPROXY_EXIST" != "" ]; then
    ...
    docker service update --image cellarstone/cellar.hub.proxy:0.45.0 \
                      --replicas 1 \
                      --update-parallelism 2 \
                      --update-delay 5s \
                      --update-order start-first \
    ...
    docker service create --name cellar-hub-proxy \
                      ...
                      --publish 8080:8080 \
                      --with-registry-auth \
                      cellarstone/cellar.hub.proxy:0.45.0 \
                      --docker \
                      --docker.swarmmode \
